...
local Library do 
    ...
    function WindIconsModule.Icon(Icon, Type, DefaultFormat)
        DefaultFormat = DefaultFormat ~= false
        local iconType, iconName = parseIconString(Icon)  
        
        local targetType = iconType or Type or WindIconsModule.IconsType  
        local targetName = iconName  
          
        local iconSet = WindIconsModule.Icons[targetType]  
    ...
    local function GetIconFromWindIcons(iconName, iconType)
        if iconName then
            local iconData = WindIconsModule:Icon(iconName, iconType or "lucide")
            if iconData and iconData[2] then
                -- Return full data including rect properties
                return {
                    Image = iconData[1],
                    ImageRectSize = iconData[2].ImageRectSize or Vector2.new(0, 0),
                    ImageRectPosition = iconData[2].ImageRectPosition or Vector2.new(0, 0)
                }
            end
        end
        return nil
    ...
    getgenv().WindIcons = WindIconsModule
    ...
    do
        ...
        Library.Window = function(self, Data)
            ...
            local Window = {
                ...
                Size = Data.Size or Vector2New(798, 599),
                SideBarSize = Data.SideBarSize or 215,  -- Sidebar width in pixels
            ...
            local Items = { } do
                ...
                Items["MainFrame"] = Instances:Create("Frame", {
                    ...
                    BorderColor3 = FromRGB(0, 0, 0),
                    Size = UDim2New(0, Window.Size.X, 0, Window.Size.Y),
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(16, 18, 18)
                ...
                Items["Side"] = Instances:Create("Frame", {
                    ...
                    BackgroundTransparency = 1,
                    BorderColor3 = FromRGB(0, 0, 0),
                    Size = UDim2New(0, Window.SideBarSize, 1, 0),
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(255, 255, 255)
                })
                ...
                Items["Content"] = Instances:Create("Frame", {
                    Parent = Items["MainFrame"].Instance,
                    Name = "\0",
                    Position = UDim2New(0, Window.SideBarSize + 5, 0, 6),
                    BorderColor3 = FromRGB(0, 0, 0),
                    Size = UDim2New(1, -(Window.SideBarSize + 11), 1, -12),
                    BorderSizePixel = 0,
                    BackgroundColor3 = FromRGB(21, 24, 24)
        ...
        Library.Page = function(self, Data)
            ...
            local Page = {
                ...
                IconType = Data.IconType or "lucide", -- For WindIcons support

                Items = { },
                SubPages = { },
                ColumnsData = { },  -- Add this for sections
                Active = false
            }
            
            -- Try to get icon from WindIcons first, fall back to asset ID
            local iconData = GetIconFromWindIcons(Page.Icon, Page.IconType)
            local iconImage, imageRectSize, imageRectPosition
            ...
            if iconData then
                ...
                iconImage = "rbxassetid://" .. Page.Icon
            ...
            local Items = { } do
                ...
                Items["Icon"] = Instances:Create("ImageLabel", {
                    ...
                    AnchorPoint = Vector2New(0, 0.5),
                    Image = iconImage,
                    ImageRectSize = imageRectSize ~= Vector2.new(0, 0) and imageRectSize or nil,
                    ImageRectOffset = imageRectPosition ~= Vector2.new(0, 0) and imageRectPosition or nil,
                    BackgroundTransparency = 1,
                ...
                -- Create column frames for sections
                for Index = 1, 2 do
                    local NewColumn = Instances:Create("Frame", {
